...
Вагин Михаил Игоревич: [(Вконтакте)](https://vk.com/meshokvagin), [(Телеграмм)](https://t.me/Meshok_vagin)

## Выводы

На примере проделанной работы мы видим, что "большие данные" часто содержат различные ошибки, пропуски и другие неприятные неточности. Всё это может привести к неправильной интерпритации информации и ошибочным выводам.

При помощи данного проекта можно привести любые массивы данных к нужной степени очистки, минимизировать риск ошибок в анализе данных и достигать поставленных целей.